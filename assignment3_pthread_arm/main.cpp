...
void gauss_thread_worker_roll_param_reduce_NEON(DynamicMatrix<float> &m) {
    assert(m.get_rows() == m.get_cols());
    int n = m.get_rows();
...
//    auto start = std::chrono::high_resolution_clock::now();
//    gauss_thread_worker_roll_param_reduce_NEON(m);
//    auto end = std::chrono::high_resolution_clock::now();
...
//            gauss_thread_worker_roll_param_reduce_avoid_false_sharing,
            gauss_thread_worker_roll_param_reduce_NEON,
    };
...
//            "thread_worker_roll_param_reduce_avoid_false_sharing",
            "thread_worker_roll_param_reduce_NEON",
    };
